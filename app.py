...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #5c61fa, #ffffff, #d47777);
        }
    </style>
""", unsafe_allow_html=True)

st.markdown("""
    <div style='text-align: center; font-size: 45px; font-weight: bold; color: #000000; margin-top: 20px;'>
        🔮 EV Charging Demand Forecaster for a County in The United States
    </div>
""", unsafe_allow_html=True)

st.markdown("""
    <div style='text-align: center; font-size: 35px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: #000000;'>
        Welcome to the Electric Vehicle (EV) Charging Demand Forecast tool.
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: left; font-size: 28px; font-weight: bold; padding-top: 10px; color: #000000;'>
...
st.markdown(f'<h3 style="color: #000000; font-weight: bold;">📊 Cumulative EV Forecast for {county} County</h3>', unsafe_allow_html=True)
...
if historical_total > 0:
    ...
    st.markdown(f"""
                <div style="background-color: #183f78; border: 1px solid rgba(255, 255, 255, 0.2); padding: 15px; border-radius: 10px; color: white; font-size: 20px; font-weight: bold;">
                    📈 Based on the graph, EV adoption in <strong>{county}</strong> is expected to show an <strong>{trend} of {forecast_growth_pct:.2f}%</strong> over the next 3 years.
                </div>
    """, unsafe_allow_html=True)
else:
...
st.markdown("---")
st.markdown(f'<h3 style="color: #000000; font-weight: bold;">📊 Compare EV Adoption Trends for up to 3 Counties</h3>', unsafe_allow_html=True)
...
if multi_counties:
    ...
    st.markdown(f'<h3 style="color: #000000; font-weight: bold;">📈 Comparison of Cumulative EV Adoption Trends', unsafe_allow_html=True)
    ...
    st.markdown(f"""
                <div style="background-color: #183f78; border: 1px solid rgba(255, 255, 255, 0.2); padding: 15px; border-radius: 10px; color: white; margin-bottom: 20px; font-size: 20px; font-weight: bold;">
                    📈 Forecasted EV adoption growth over next 3 years — {growth_sentence}
                </div>
    """, unsafe_allow_html=True)

st.markdown("""
            <div style="background-color: #183f78; border: 1px solid rgba(255, 255, 255, 0.2); padding: 15px; border-radius: 10px; color: white; text-align: center; font-size: 20px; font-weight: bold;">
                ✅ Forecast complete
            </div>
""", unsafe_allow_html=True)

st.markdown("""
            <h3 style="color: #000000; text-align: center; font-size: 20px; font-weight: bold; margin-top: 20px">
                Prepared for the **AICTE Artificial Intelligence Internship** <br> Developed by: [Satya Prakash Patnaik]
            </h3>
""", unsafe_allow_html=True)